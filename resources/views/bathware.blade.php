...
<head>
    ...
    <title>Bathware - ABC Sanitation and Marble</title>
...
<body>
    ...
    <nav class="inner-navbar">
        <div class="nav-left">
            ...
            <a href="/bathware" style="font-weight: 600;">Bathware</a>
    ...
    <div class="page-container">
        <h1>Bathware</h1>
        <p>Discover our range of sanitaryware, vanity alternatives, fittings, and fixtures crafted for luxury and everyday comfort.</p>
